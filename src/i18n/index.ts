...
export const LABELS: Record<CoreLocale, LabelBundle> = {
  "de": {
    "appgroup": "Webkamera-Bildarchiv",
    "apps": {
      "webkamera_verwaltung": {
        "name": "Webkamera-Verwaltung",
        "app_id": "69e1f9b9e099184b4f891185",
        "fields": {
          "kamera_name": "Kameraname",
          "kamera_standort": "Standortbeschreibung",
          "kamera_url": "Stream-URL",
          "kamera_geo": "Geografischer Standort",
          "kamera_beschreibung": "Beschreibung",
      ...
      "bilderfassung": {
        "name": "Bilderfassung",
        "app_id": "69e1f9bc1913ab36ef161891",
        "fields": {
          "schritt1": "Schritt1",
          "referenzbild_datei": "Referenzbild",
          "kamera_referenz": "Webkamera",
          "aufnahmezeitpunkt": "Aufnahmezeitpunkt",
          "bild_datei": "Bild",
          "bild_notiz": "Notiz",
          "bild_qualitaet": "Bildqualität",
          "ki_prompt": "Prompt",
          "ki_auswertung": "KI-Auswertung",
          "ki_messwert": "Messwert",
          "ki_kriterium_erfuellt": "Kriterium erfüllt"
        },
        "lookups": {
          "bild_qualitaet": {
            "gut": "Gut",
  ...
  "en": {
    "appgroup": "Webcam Image Archive",
    "apps": {
      "webkamera_verwaltung": {
        "name": "Webcam Management",
        "app_id": "69e1f9b9e099184b4f891185",
        "fields": {
          "kamera_name": "Camera Name",
          "kamera_standort": "Location Description",
          "kamera_url": "Stream URL",
          "kamera_geo": "Geographic Location",
          "kamera_beschreibung": "Description",
          "kamera_status": "Status"
        },
        "lookups": {
          "kamera_status": {
      ...
      "bilderfassung": {
        ...
        "fields": {
          "schritt1": "Step 1",
          "referenzbild_datei": "Reference Image",
          "kamera_referenz": "Webcam",
          "aufnahmezeitpunkt": "Capture Timestamp",
          "bild_datei": "Image",
          "bild_notiz": "Note",
          "bild_qualitaet": "Image Quality",
          "ki_prompt": "Prompt",
          "ki_auswertung": "AI Evaluation",
          "ki_messwert": "Measured Value",
          "ki_kriterium_erfuellt": "Criterion Met"
        },
        "lookups": {
          "bild_qualitaet": {
            "gut": "Good",
