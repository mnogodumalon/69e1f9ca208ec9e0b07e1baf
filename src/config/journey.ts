 ...
 *   - webkamera_verwaltung: lookups kamera_status[aktiv|inaktiv|wartung]
 *   - bilderfassung: applookups kamera_referenz→webkamera_verwaltung · lookups bild_qualitaet[gut|mittel|schlecht]
 */
