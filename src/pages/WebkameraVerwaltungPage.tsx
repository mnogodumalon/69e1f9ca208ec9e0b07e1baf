...
export default function WebkameraVerwaltungPage() {
  ...
  async function loadData() {
    setLoading(true);
    try {
      setRecords(await LivingAppsService.getWebkameraVerwaltung());
    } finally {
      setLoading(false);
    }
  }

  async function handleCreate(fields: WebkameraVerwaltung['fields']) {
  ...
  async function handleUpdate(fields: WebkameraVerwaltung['fields']) {
    ...
    await LivingAppsService.updateWebkameraVerwaltungEntry(editingRecord.record_id, fields);
    await loadData();
  ...
  async function handleDelete() {
    ...
    await LivingAppsService.deleteWebkameraVerwaltungEntry(deleteTarget.record_id);
